...
export function Hero() {
  ...
  style={{ backgroundImage: `url(/img/hero_bg.png)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>

        <div className="bg-white bg-opacity-50 p-6 rounded mr-auto place-self-center lg:col-span-7">
